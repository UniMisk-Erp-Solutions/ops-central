...
| [keyboard-control.md](./keyboard-control.md) | Working without a mouse | Every screen from the keyboard: row movement, the command palette, `g` jumps, dialog focus traps, and the rule that nothing fires while you are typing. |
